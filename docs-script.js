...
// Asegurar que la búsqueda funcione con el nuevo contenido
document.addEventListener('DOMContentLoaded', function() {
    const searchInput = document.getElementById('searchInput');
    const searchButton = document.getElementById('searchButton');
        ...
        searchInput.addEventListener('input', function() {
            ...
            if (visibleCount === 0 && searchTerm !== '') {
                if (!existingMsg) {
                    ...
                    msg.innerHTML = '<i class="fas fa-search"></i> No se encontraron comandos con "<strong>' + searchTerm + '</strong>"';
                    document.querySelector('.docs-content').insertBefore(msg, document.querySelector('.docs-content').firstChild);
                } else {
                    existingMsg.style.display = '';
                    existingMsg.innerHTML = '<i class="fas fa-search"></i> No se encontraron comandos con "<strong>' + searchTerm + '</strong>"';
                }
            } else if (existingMsg) {
